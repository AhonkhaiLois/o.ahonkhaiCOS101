fn main() {
    let n1 = "Electrocal".to_string();
    let n2 = "Electronic".to_string();
    let n3 = "Engineering".to_string();
    let n4 = n1 + &n2 + &n3; //n2 & n3 reference is  passed

    //About Electrical/Electronic
    println!("\nThe {} is informef by the aspiration to train electrical/electronic emgineering profesionals in the areas of design, building and maintenance of electrical control system,",n4);
